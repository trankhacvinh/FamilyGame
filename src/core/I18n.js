...
const DICTIONARY = {
  vi: {
    ...
    clawTitle: 'Máy Gắp Thú 🧸',
    clawDescription: 'Kéo càng sang trái phải, bấm Gắp và thu thập đồ chơi',
    clawScore: 'Đã gắp',
    clawCollection: 'Bộ sưu tập',
    clawDragHint: '👆 Vuốt ngang để đưa càng tới món đồ',
    clawGrab: '🕹️ GẮP!',
    clawNewGame: '🔄 Chơi mới',
    clawReady: 'Chọn món đồ rồi bấm Gắp!',
    clawLowering: 'Càng đang hạ xuống…',
    clawGrabbing: 'Kẹp lại nào!',
    clawGotOne: 'Gắp được rồi! 🎉',
    clawMiss: 'Chưa trúng rồi, thử lại nhé!',
    clawReturning: 'Càng đang quay lại…',
    clawComplete: 'Đã gắp hết đồ chơi! Bấm Chơi mới để chơi lại.',
    brushTitle: 'Đánh Răng Cho Cá Sấu 🐊🪥',
    brushDescription: 'Kéo bàn chải qua từng chiếc răng bẩn cho đến khi sáng bóng',
    brushProgress: 'Răng sạch',
    brushHint: '👆 Kéo bàn chải qua những chiếc răng bẩn',
    brushNewGame: '🔄 Chải lại',
    brushInstruction: 'Đánh răng cho cá sấu nào!',
    brushToothClean: 'Răng sạch rồi!',
    brushComplete: 'Răng sạch bóng rồi! Bé giỏi quá!',
    brushCompleteTitle: 'SẠCH BÓNG! ✨',
    hiddenTitle: 'Tìm Đồ Vật 🔎',
    hiddenDescription: 'Quan sát căn phòng, nghe gợi ý và chạm đúng đồ vật',
    hiddenFind: 'Hãy tìm',
    hiddenFound: 'Tìm thấy rồi!',
    hiddenWrong: 'Chưa đúng, nhìn kỹ lại nhé!',
    hiddenScore: 'Đã tìm',
    hiddenRepeat: 'Đọc lại gợi ý',
    hiddenNewGame: '🔄 Chơi lại',
    hiddenComplete: 'Tìm thấy hết rồi! Bé giỏi quá!',
    hiddenCompleteTitle: 'TÌM THẤY HẾT! 🎉',
  ...
  en: {
    ...
    clawTitle: 'Claw Machine 🧸',
    clawDescription: 'Slide the claw left or right, press Grab, and collect the toys',
    clawScore: 'Collected',
    clawCollection: 'Collection',
    clawDragHint: '👆 Swipe sideways to aim the claw',
    clawGrab: '🕹️ GRAB!',
    clawNewGame: '🔄 New Game',
    clawReady: 'Choose a toy, then press Grab!',
    clawLowering: 'The claw is going down…',
    clawGrabbing: 'Closing the claw!',
    clawGotOne: 'Got one! 🎉',
    clawMiss: 'Almost! Try again!',
    clawReturning: 'The claw is coming back…',
    clawComplete: 'All toys collected! Press New Game to play again.',
    brushTitle: 'Brush the Crocodile’s Teeth 🐊🪥',
    brushDescription: 'Drag the toothbrush over every dirty tooth until it sparkles',
    brushProgress: 'Clean teeth',
    brushHint: '👆 Brush back and forth over the dirty teeth',
    brushNewGame: '🔄 Brush Again',
    brushInstruction: 'Let’s brush the crocodile’s teeth!',
    brushToothClean: 'Clean tooth!',
    brushComplete: 'Sparkling clean teeth! Great job!',
    brushCompleteTitle: 'SPARKLING CLEAN! ✨',
    hiddenTitle: 'Hidden Objects 🔎',
    hiddenDescription: 'Look around the room, listen to the clue, and tap the right object',
    hiddenFind: 'Find the',
    hiddenFound: 'You found it!',
    hiddenWrong: 'Not that one. Look again!',
    hiddenScore: 'Found',
    hiddenRepeat: 'Read the clue again',
    hiddenNewGame: '🔄 Play Again',
    hiddenComplete: 'You found everything! Great job!',
    hiddenCompleteTitle: 'ALL FOUND! 🎉',
    greatJob: 'GREAT JOB! 🎉',
    circle: 'Circle',
    square: 'Square',
    triangle: 'Triangle',
